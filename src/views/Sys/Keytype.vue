  ...
  <div class="page-container">
    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size">
        <el-form-item>
          <el-input v-model="filters.name" placeholder="关键字类型"></el-input>
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {prop: "value", label: "类型", minWidth: 120},
  ...
  methods: {
    ...
    findPage: function (data) {
      ...
      this.$api.keytype.findPage(this.pageRequest).then((res) => {
    ...
    handleDelete: function (data) {
      this.$api.keytype.batchDelete(data.params).then(data.callback)
    },
      ...
      this.$refs.dataForm.validate((valid) => {
        if (valid) {
          this.$confirm('确认提交吗？', '提示', {}).then(() => {
            ...
            this.$api.keytype.save(params).then((res) => {
    ...
    handleRoleSelectChange(val) {
      ...
      this.$api.keytype.findKeyWords({'keytypeId': val.val.id}).then((res) => {
